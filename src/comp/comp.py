...
c = [hum.name for hum in humans if hum.name [0] >= 'C' if hum.name[0] <='G']
print(c)
...
e = [hum.name + '-' + str(hum.age) for hum in humans]
print(e)
...
f = [(hum.name, hum.age) for hum in humans if hum.age >=27 and hum.age <=32]
print(f)
